...
# Google Drive 파일 ID
file_id = '1mnuwSjWM6qfkDbX--HO_J9JmTvy_5Ovq'
...
content_data = {
    labels[0]: {
        ...
        'texts': [
            "고긴스 관련 첫 번째 텍스트 내용입니다.",
            "고기 1 관련 두 번째 텍스트 내용입니다.",
            "먹고싶다 1 관련 세 번째 텍스트 내용입니다."
        ]
    },
    labels[1]: {
        'images': [
        ...
        'texts': [
            "드레레 2 관련 첫 번째 텍스트 내용입니다.",
            "사단 2 관련 두 번째 텍스트 내용입니다.",
            "에미넴 2 관련 세 번째 텍스트 내용입니다."
        ]
    },
    labels[2]: {
        'images': [
        ...
        'texts': [
            "디젤 3 관련 첫 번째 텍스트 내용입니다.",
            "엔진 3 관련 두 번째 텍스트 내용입니다.",
            "열기관 3 관련 세 번째 텍스트 내용입니다."
        ]
    }
}
